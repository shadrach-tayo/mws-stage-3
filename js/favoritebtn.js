class FavoriteBtn {
  ...
  render() {
    ...
    this.el.setAttribute('title', this.isFavorite ? `unfavorite ${this.restaurant.name}` : `favorite ${this.restaurant.name}`);
    this.el.setAttribute('aria-checked', this.isFavorite);
    this.el.setAttribute('aria-label', this.isFavorite ? `unfavorite ${this.restaurant.name}` : `favorite ${this.restaurant.name}`);
